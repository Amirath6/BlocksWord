...
/**
 * <b>
 * Class representing an heuristic that computes the number of wrong variables in a state
 * compared to the goal
 * </b>
 *
 * <p>
 * This heuristic computes the number of wrong variables in a state compared to the goal. <br>
 ...
 * It is not monotone because even if the number of wrong variables decreases, the cost of
 ...
 * @version 1.0
 */
public class WrongVariablesHeuristic implements Heuristic {
    ...
    /**
     * Constructor of the class WrongVariablesHeuristic
     *
     * @param goal the goal
     */
    public WrongVariablesHeuristic(Goal goal) {
        this.goal = goal;
    }

    @Override
    public float estimate(Map<Variable, Object> state) {
        float wrongVariables = 0;
